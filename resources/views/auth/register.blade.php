                    ...
                    <div class="row">
                        ...
                        <div class="form-group @error('email')has-error @enderror col">
                            ...
                            <input type="email" name="email" class="form-control" value="{{ old('email') }}"
                                placeholder="kredo@example.com" required>
                            @error('email')
                                <span class="errorMessage">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group @error('password')has-error @enderror col">
                            ...
                            <input type="password" name="password" class="form-control"
                                placeholder="Please enter at least 8 characters" required>
                            @error('password')
                                <span class="errorMessage">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="tel" name="contact_number" class="form-control"
                                value="{{ old('contact_number') }}" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}"
                                placeholder="Phone number without hyphen" maxlength="11">
                        ...
                        <div class="form-group col">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="gender" value="0" type="radio"
                                    id="inlineRadio1">
                                <label class="form-check-label" for="inlineRadio1">Male</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="gender" value="1" type="radio"
                                    id="inlineRadio2">
                    ...
                    <div class="row">
                        <div class="col snsIcons">
                            <a href="{{ route('google.redirect') }}">
                                ...
                                <span class="snsSignup">Sign up with Google</span>
                            </a>
                        </div>
                        <div class="col snsIcons">
                            <a href="{{ route('facebook.redirect') }}">
                                <img src="/images/facebook.png" alt="">
                                <span class="snsSignup">Sign up with Facebook</span>
                            </a>
                        </div>
                    </div>
