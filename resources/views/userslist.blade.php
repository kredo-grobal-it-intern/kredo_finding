                    ...
                    @foreach ($users as $user) 
                        <div class="card seven col-xl-3 col-lg-4 col-md-6 mt-4 p-1">
                            <div class="card-header">
                                <div class="avatar">
                                    <a href="{{ route('user_detail.show', $user->id) }}">{{ workerProfileImage($user->img_name) }}</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="bio">
                    ...
                    @foreach ($job_postings as $jobPosting)
                        <div class="card five col-xl-5 col-lg-5 col-md-4 m-3">
                            <div class="title mt-3">
                                <div class="occupation h3">{{ App\Constants\Occupation::Occupation[$jobPosting->occupation] }}
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="avatar col-3">
                                        <a href="#">{{ companyImageInUserlist($jobPosting->companyUser->img_name) }}</a>
                                    </div>
