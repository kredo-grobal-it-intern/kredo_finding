  ...
  <div class="loginPage">
    <div class="container">
      <div class="loginPage_contents">
        ...
        <div class="btn loginPage_contents_btn bg-white border"><a class="text-primary" href="{{ url('/auth/redirect') }}"><i class="fa-brands fa-facebook"></i>Log in with Facebook</a></div>
