...
@section('content')
    <div class="loginPage">
        <div class="menu_top d-flex" style="position:absolute; top:12%; right:5rem;">
            <div class="menu" style="z-index: 1;">
                ...
                <a href="{{ route('contact.show') }}"class="text-white text-decoration-none">CONTACT US
                    &nbsp;&nbsp;&nbsp;</a>
            </div>
        </div>
        ...
        <div class="btn loginPage_new_account_btn bg-white mx-auto mt-3">
            <a class="text-dark" href="{{ route('register') }}">Create New Account</a>
        </div>
    </div>
@endsection
